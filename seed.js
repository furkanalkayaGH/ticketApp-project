 ...
 *  description,
 *  image,
 *  type: cinema, concert, theater, sport,
 *  seatRows: 4,
 *  seatColumns: 6,
 *  totalSeats: 24
 * }
...
const events = [
  ...
  {
    adult: false,
    backdrop_path: "/6NWJLzckS3QR4g1mZacjQHZysVZ.jpg",
    genre_ids: [18, 80],
    id: 598,
    original_language: "pt",
...
const createEvents = async () => {
  for (const event of events) {
    await setDoc(doc(db, "events", event.id.toString()), {
      ...
      type: "cinema",
      image: "https://image.tmdb.org/t/p/w500" + event.poster_path,
      seatRows: 6,
      seatColumns: 6,
      totalSeats: 36,
    });
